...
class CouchdbSource extends DataSource
{
     ...
     * @param int $autoConnect Autoconnect
     * @return bool
     */
    ...
    public function connect()
    {
        if ($this->connected !== true) {
            ...
            if (strpos($this->Socket->get(), 'couchdb') !== false) {
                ...
                return $this->cakeError('missingConnection', [['code' => 500, 'className' => 'CouchdbSource']]);
            }
        }
     ...
     * @param int $recursive Level number of associations.
     ...
     *
     * @param string json $data
     * @param bool $assoc If true, returns array. If false, returns object.
