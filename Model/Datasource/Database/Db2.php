...
class DboDb2 extends DboSource
{
     ...
     */
    public $columns = [
        'primary_key' => ['name' => 'not null generated by default as identity (start with 1, increment by 1)'],
        'string' => ['name' => 'varchar', 'limit' => '255'],
        'text' => ['name' => 'clob'],
        'integer' => ['name' => 'integer', 'limit' => '10', 'formatter' => 'intval'],
        'float' => ['name' => 'double', 'formatter' => 'floatval'],
    ...
    protected function _execute($sql)
    {
        ...
        if (!is_bool($result)) {
            ...
            while ($j < $numFields) {
                ...
                $map[$index++] = [$tableName, $columnName];
                $j++;
    ...
    public function &describe($model)
    {
        ...
        while (db2_fetch_row($result)) {
            $fields[strtolower(db2_result($result, 'COLUMN_NAME'))] = [
    ...
    public function column($real)
    {
        ...
        if (in_array($col, ['double', 'real', 'decimal'])) {
            return 'float';
        }
